...
export default function ProjectCard({
  ...
  const handleActionsRedeploy = (cleanupVolumes: boolean) => {
    ...
    handleAction("redeploy", () =>
      redeployProject(project.id, project.image ?? "", project.internal_port ?? 3000, project.cmd, project.memory_limit_mb, project.cpu_limit, cleanupVolumes),
    );
  };
        ...
        <div className="flex gap-2">
          ...
          <div className="flex-1">
            {openPopover === "sleep" ? (
              <SleepPopover
                project={project}
                onChange={(as, tm, astart) => { setAutoStop(as); setTimeoutMins(tm); setAutoStart(astart); }}
