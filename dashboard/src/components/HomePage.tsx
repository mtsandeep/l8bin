...
export default function HomePage() {
  ...
  const refreshKey = (location.state as { refresh?: number } | null)?.refresh;

  const { projects, stats, systemStats, loading, loadProjectsAndStats } = useHomeData(user, refreshKey);
