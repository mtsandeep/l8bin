    ...
    pub fn from_env() -> anyhow::Result<Self> {
        Ok(Self {
            ...
            janitor_interval_secs: env::var("JANITOR_INTERVAL_SECS")
                ...
                .parse()?,
            flush_interval_secs: env::var("FLUSH_INTERVAL_SECS").unwrap_or_else(|_| "60".into()).parse()?,
            ...
            heartbeat_interval_secs: env::var("HEARTBEAT_INTERVAL_SECS").unwrap_or_else(|_| "30".into()).parse()?,
            public_ip: env::var("PUBLIC_IP").unwrap_or_default(),
            routing_mode: match env::var("ROUTING_MODE").unwrap_or_else(|_| "master_proxy".into()).as_str() {
